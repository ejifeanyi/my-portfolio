...
export const projects: Array<ProjectItemType> = [
  {
    ...
    tags: ['Fintech', 'Stocks', 'AI', 'Finance', 'System Design'],
  },
  // {
  //   name: 'AI Best Tools',
...
export const githubProjects: Array<ProjectItemType> = [
  {
    ...
    description:
      'Open-source command-line tool to quickly generate REST API boilerplates with optional authentication and database setup.',
    link: {
      href: 'github.com/ejifeanyi/rest-api-generator-cli',
      label: 'Rest API Generator CLI',
    },
    gitStars: 203,
    gitForks: 67,
  },
  {
    ...
    link: {
      href: 'github.com/ejifeanyi/dev-task-scheduler',
      label: 'Dev Task Scheduler',
    },
    gitStars: 203,
    gitForks: 67,
  },
  {
    ...
    description:
      'A simple command-line task scheduler with email notifications.',
    link: {
      href: 'github.com/ejifeanyi/frontapi',
      label: 'FrontAPi',
    },
    gitStars: 203,
    gitForks: 67,
